...
if [ $1 ]; then
	...
	python3 ./create_bsp_images.py  --chain A -b p3898-b00 -B qspi -r 1 -g $FLASH_OUTDIR -D --customer-data $TEGRA_TOP/drive-foundation/tools/flashtools/bootburn_t23x_py/customer_data_orin_c.json $TEGRA_TOP/drive-foundation/tools/flashtools/bootburn_t23x_py/nv-customer-data-schema.json 	
